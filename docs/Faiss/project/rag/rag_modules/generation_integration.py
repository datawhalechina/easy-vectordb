...
class GenerationIntegrationModule:
    ...
    def __init__(self, model_name: str = "kimi-k2-0711-preview", temperature: float = 0.1, max_tokens: int = 2048 , api_key:str = "sk-zzz"):
        """
        初始化生成集成模块
        """
        ...
        # api_key = os.getenv("sk-iQ5zUoNiRcBAeluL2AcuUxxasfg6dzrmMXlh57Cc5eu0q6E0")
        # if not api_key:
